Feature: Admin menambah riwayat pengabdian
...
Background:
    ...
    Scenario: Positif - Menambahkan data dengan benar
        When "Admin" menuju ke halaman "http://localhost/siacloud/hr/list_rpkm/1"
        ...
        * "Admin" mengisi field "Judul Kegiatan" dengan "Perancangan Aset Konten Digital untuk Kegiatan Promosi Agrowisata PT Perkebunan Nusantara VIII"
