Feature: User melakukan pendaftaran pada jalur yang dipilih
        ...
        Examples:
              ...
              | janu romadhon | 08971186711 | 04-04-2005 | laki laki     | janua@mail.com | kab. ilir    | 3340871985617722 | SMA/SMK Sederajat | jawa timur | kabupaten mojokerto | sman          | 2020     | IPA     | sma n 1        | ya         |

        Scenario: User melakukan pendaftaran pendidikan terakhir D3
          When Pendaftar memilih jenjang "S1" prodi "Teknik Informatika"
          * Pendaftar memilih jalur pendaftaran "Rekognisi Pembelajaran Lampau"
          * Pendaftar klik tombol isi fomulir pendaftaran 
          * Pendaftar mengisi data "nama pendaftar" dengan "<nama>" di v2
          * Pendaftar mengisi data "no hp" dengan "<no_hp>" di v2
